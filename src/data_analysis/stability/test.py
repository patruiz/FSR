...
names = ["4.00", "4.25", "4.50", "4.75", "5.00", "5.25", "5.50", "5.75", "6.00", "6.25", "6.50", "6.75", "7.00", "7.25"]
...
for i in names:
    ...
    plt.subplot(1, 2, 1)
    sns.histplot(ohms, kde=False, color='skyblue', bins=30, stat='density', edgecolor='black')
